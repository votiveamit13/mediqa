...
@section('js')
    <script>
        const API_URL = "{{ url('healthcare-facilities/notifications') }}";
        const READ_URL = "{{ url('healthcare-facilities/notifications/read') }}";
        const READ_ALL_URL = "{{ url('healthcare-facilities/notifications/read-all') }}";
