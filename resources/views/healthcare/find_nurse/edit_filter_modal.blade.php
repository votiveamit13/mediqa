            ...
            <div id="employeementTypeBody" class="modal-body">
                <div id="layer-0" class="layer" style="display:block;">
                    ...
                    <label class="sub-heading speciality-item" data-id="{{ $list->emp_prefer_id }}">
                        <input type="checkbox" id="main-category-checked" name="employment_type[]" class="employeement_type_checkbox" value="{{ $list->emp_prefer_id }}">
...
@endif
@if($modal_no == 33)
<div class="modal-overlay" id="Location_prefer_modal">
    <div class="modal-content modal-content-preferences">
        <div class="modal-header">
            <h4>Location Preferences</h4>
            <span class="close-btn" id="closeLocationModal" data-close="Location_prefer_modal" onclick="closeLocationPreferences()">&times;</span>
        </div>
        <div class="modal-body">
            <div class="international_hiring_drop form-group level-drp source_countries">
                <label class="form-label" for="input-1">Country
                </label>
                <input type="hidden" name="state_lat_edit" class="state_lat_edit" value="">
                <input type="hidden" name="state_long_edit" class="state_long_edit" value="">
                @php
                    $get_countries = country_name_from_db();
                @endphp
                <input type="hidden" name="hf_country" class="hf_country" value="">
                
                <select class="form-control form-select filter_country_edit" name="hf_filter_coutry_edit[]">
                    <option value=""></option>
            ...
            <div class="form-group level-drp">
                ...
                @endphp
                <select class="form-control form-select" name="job_state_edit" id="job_state_edit" onchange="changeState(this.value)">
            ...
            <div class="radius-filter">
                ...
                <input type="hidden" name="radiusInput_edit" class="radiusInput_edit" value="25">
                <input type="range"
                    id="radiusSlider_edit"
                    min="5"
                    max="100"
                    step="5"
                    value="25"
                    class="radius-slider-edit">
        ...
        <div class="modal-footer">
            ...
            <button class="apply-btn apply-filter-btn" id="applyLocation" onclick="applyLocationFilter()">Apply</button>
        </div>
    </div>
</div>
<script>
      ...
      $.ajax({
          ...
          success: function(data) {
              if(data != ""){
                  ...
                  $(".state_lat_edit").val(state_data.latitude);
                  $(".state_long_edit").val(state_data.longitude);
    ...
    function applyLocationFilter(){
        var state_lat = $(".state_lat_edit").val();
        var state_long = $(".state_long_edit").val();
        var radius = $(".radiusInput_edit").val();

        var country = $(".filter_country_edit").val();
...
@if($modal_no == 34)
<div class="modal-overlay" id="residency_status_modal">
        ...
        <div class="modal-content">                
            ...
            <div class="modal-body">
                <div class="form-group level-drp">
                    ...
                    <ul id="residency_status_edit" style="display:none;">
                    ...
                    <select class="js-example-basic-multiple addAll_removeAll_btn" data-list-id="residency_status_edit" name="residency_status_edit[]" multiple></select>
                    
                    
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" onclick="applyWorkStatusEdit()">
                    Apply
                </button>
            </div>
        </div>
...
<script>
    ...
    $(".work-status-close").click(function(){
        $("#residency_status_modal").hide();
    });

    function applyWorkStatusEdit(){
        var work_status_value = $('.js-example-basic-multiple[data-list-id="residency_status_edit"]').val();
        
        // Retrieve existing filters from sessionStorage
        var filter_data = sessionStorage.getItem("filters_data_saved");
        console.log("work_status_value",filter_data);
        var filters_data = filter_data ? JSON.parse(filter_data) : {};
...
@endif
@if($modal_no == 35)
<div id="hiring_edit_modal" class="modal-overlay" style="display: none;z-index:99!important">
    <div class="modal-content modal-content-preferences">
        <div class="modal-header">
            <h4>International hiring</h4>
            <span class="close-btn" id="closeHiringModal" data-close="internationalHiringModal">&times;</span>
        </div>
        @php
            $get_countries = country_name_from_db();
        @endphp
        <div class="hiringModalBody modal-body">
            <div class="international_hiring_drop form-group level-drp">
                ...
                <select class="js-example-basic-multiple addAll_removeAll_btn" data-list-id="international_hiring" name="emr_ehr_data[]" multiple onchange="changeHiring()"></select>
                <span id='reqsector_preferences' class='reqError text-danger valley'></span>
                
            </div>
            <div class="international_hiring_drop form-group level-drp source_countries" style="display:none;">
                ...
                <select class="js-example-basic-multiple addAll_removeAll_btn" data-list-id="international_countires" name="emr_ehr_data[]" multiple></select>
                <span id='reqsector_preferences' class='reqError text-danger valley'></span>
        ...
        <div class="modal-footer">
            ...
            <button class="apply-btn apply-filter-btn" id="applyHiringEdit" onclick="applyHiringEdit()">Apply</button>
        </div>
    </div>
...
<script>
    ...
    $("#closeHiringModal").click(function(){
        $("#hiring_edit_modal").hide();
    });

    function applyHiringEdit(){
        ...
        let filter_data = sessionStorage.getItem("filters_data_saved");
